...
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((wlan_dispatch_smf_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
extern "C" {
	...
	VosT_Address _op_wlan_dispatch_smf_alloc (VosT_Obtype, int);
...
VosT_Address
_op_wlan_dispatch_smf_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	...
	ptr = (wlan_dispatch_smf_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
